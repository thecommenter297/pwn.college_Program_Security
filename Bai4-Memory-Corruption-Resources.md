...
| **short int** | 16 | 2 | $-2^{15}$ ($-32,768$) | $2^{15}-1$ ($32,767$) |
| **unsigned short** | 16 | 2 | $0$ | $2^{16}-1$ ($65,535$) |
| **int** | 32 | 4 | $-2^{31}$ ($-2,147,483,648$) | $2^{31}-1$ ($2,147,483,647$) |
| **unsigned int** | 32 | 4 | $0$ | $2^{32}-1$ ($4,294,967,295$) |
| **int32_t** | 32 | 4 | $-2^{31}$ ($-2,147,483,648$) | $2^{31}-1$ ($2,147,483,647$) |
| **uint32_t** | 32 | 4 | $0$ | $2^{32}-1$ ($4,294,967,295$) |
| **long int** | 64 | 8 | $-2^{63}$ ($-9,223,372,036,854,775,808$) | $2^{63}-1$ ($9,223,372,036,854,775,807$) |
| **unsigned long** | 64 | 8 | $0$ | $2^{64}-1$ ($18,446,744,073,709,551,615$) |
| **long long int** | 64 | 8 | $-2^{63}$ ($-9,223,372,036,854,775,808$) | $2^{63}-1$ ($9,223,372,036,854,775,807$) |
| **unsigned long long** | 64 | 8 | $0$ | $2^{64}-1$ ($18,446,744,073,709,551,615$) |
| **int64_t** | 64 | 8 | $-2^{63}$ ($-9,223,372,036,854,775,808$) | $2^{63}-1$ ($9,223,372,036,854,775,807$) |
| **uint64_t** | 64 | 8 | $0$ | $2^{64}-1$ ($18,446,744,073,709,551,615$) |

---

**Lưu ý**: Ở kiểu **`long`**: 
*   Trên **Windows 64-bit**: `long` vẫn chỉ có 32-bit.
*   Trên **Linux 64-bit**: `long` là 64-bit.
